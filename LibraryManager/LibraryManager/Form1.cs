...
namespace LibraryManager
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            toolStripMenuItem1.Click += 도서관리ToolStripMenuItem1_Click;
            toolStripMenuItem2.Click += 사용자관리ToolStripMenuItem2_Click;
        }
        ...
        private void 사용자관리ToolStripMenuItem2_Click(object sender, EventArgs e)
        {
